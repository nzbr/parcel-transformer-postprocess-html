...
import type {Async, MutableAsset, PluginOptions} from '@parcel/types';
...
export default new Transformer<{}>({
    ...
    async transform({asset, options}) {
        const config = await import(`${options.projectRoot}/postprocessor.config.js`) as PostprocessorConfig;
